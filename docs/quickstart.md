...
We recommend using `dotenv` module to manage your environment. With `dotenv` you'll be using the `.env` files to define your environment variables.
...
# Next Steps
- Experiment with different levels of parallelism. Learn more about how [parallelism](./parallelism.md) works with Playwright.

- Run tests in a [CI/CD pipeline.](./cicd.md)

- Learn how to [manage access](./assign-roles.md) to the created workspace.
